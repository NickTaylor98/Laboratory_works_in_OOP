...
Candy::Candy() : Kond_izd::Kond_izd() { Percentege_of_sugar = 0; Taste.setId(0); Weight = 0; }
...
Candy::Candy(ui perc, ui id, ui weight) : Kond_izd() { setPerc(perc); Taste.setId(id); Weight = weight; }
